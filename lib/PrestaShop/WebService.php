...
class WebService
{
     ...
     * try
     * {
     * 	$ws = new WebService('http://mystore.com/', 'ZQ88PRJX5VWQHCWE4EE7SQ7HPNX00RAJ', false);
    ...
    protected function checkStatusCode($status_code) {
        ...
        switch ($status_code) {
            ...
            case 204: throw new WebServiceException(sprintf($error_label, $status_code, 'No content'));
                break;
            case 400: throw new WebServiceException(sprintf($error_label, $status_code, 'Bad Request'));
                break;
            case 401: throw new WebServiceException(sprintf($error_label, $status_code, 'Unauthorized'));
                break;
            case 404: throw new WebServiceException(sprintf($error_label, $status_code, 'Not Found'));
                break;
            case 405: throw new WebServiceException(sprintf($error_label, $status_code, 'Method Not Allowed'));
                break;
            case 500: throw new WebServiceException(sprintf($error_label, $status_code, 'Internal Server Error'));
                break;
